 ...
 * @LastEditTime: 2023-08-11 17:44:34
 * @Description:
 */
...
var wasmBinaryFile;
wasmBinaryFile = 'libffmpeg_264_265.wasm';
...
var _flushDecoder = (Module['_flushDecoder'] = function () {
  return (_flushDecoder = Module['_flushDecoder'] = Module['asm']['flushDecoder']).apply(null, arguments);
});
var _closeDecoder = (Module['_closeDecoder'] = function () {
  return (_closeDecoder = Module['_closeDecoder'] = Module['asm']['closeDecoder']).apply(null, arguments);
});
...
var _ff_h264_cabac_tables = (Module['_ff_h264_cabac_tables'] = 73733);
